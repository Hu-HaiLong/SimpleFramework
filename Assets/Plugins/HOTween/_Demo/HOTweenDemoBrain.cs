...
public class HOTweenDemoBrain : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Color colorTo = CubeTrans3.GetComponent<MeshRenderer>().material.color;
        colorTo.a = 0;
        ...
        sequence.Insert(sequence.duration * 0.5f, HOTween.To(CubeTrans3.GetComponent<MeshRenderer>().material, sequence.duration * 0.5f, new TweenParms().Prop("color", colorTo)));
