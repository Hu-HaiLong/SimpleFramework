...
public class SQLiteHelper
{
    ...
    public SqliteDataReader InsertValues(string tableName, string[] colNames, string[] values)
    {
        ...
        {
            throw new SqliteException("values.Length!=values.Length");
        }
    ...
    public SqliteDataReader CreateTable(string tableName, string[] colNames, string[] colTypes, string[] colPara)
    {
        string queryString = "CREATE TABLE " + tableName + "( " + colNames[0] + " " + colTypes[0] + " " + colPara[0];
        for (int i = 1; i < colNames.Length; i++)
        {
            queryString += ", " + colNames[i] + " " + colTypes[i] + " " + colPara[i];
        }
        queryString += "  ) ";
        return ExecuteQuery(queryString);
    }
