...
public class AudioManager : MonoBehaviour
{
    ...
    public void SoundPlay(string audioname, float volume)
    {
    ...
    /// </summary>  
    /// <param name="audioname"></param>  
    public void SoundPlay(string audioname,AudioCallBack callback = null)
    {
        if (AudioDictionary.ContainsKey(audioname))
        {
            if (AudioDictionary[audioname] <= MaxAudioCount)
            {
                ...
                if (sound != null)
                {
                    StartCoroutine(this.PlayClipEnd(sound, audioname, callback));
                    this.PlayClip(sound, audioVolume);
                    AudioDictionary[audioname]++;
                }
            }
        }
    ...
    public void audioSetVolume(float volume)
    {
        ...
        if (this.LastAudioSource != null)
        {
            this.LastAudioSource.volume = volume;
        }
    }
    ...
    public void BGMPlay(string bgmname, float volume)
    {
        if(bgming != bgmname)
        {
            BGMStop();
    ...
    public void BGMPlay(string bgmname)
    {
        if (bgming != bgmname)
        {
            ...
            if (bgmname != null)
            {
                ...
                if (bgmsound != null)
                {
                    this.PlayLoopBGMAudioClip(bgmsound, bgmVolume);
                    bgming = bgmname;
                }
            }
        }
    ...
    /// </summary>  
    /// <returns></returns>  
    private IEnumerator PlayClipEnd(AudioClip audioclip, string audioname, AudioCallBack callback = null)
    {
        if (audioclip != null)
        {
            yield return new WaitForSeconds(audioclip.length * Time.timeScale);
